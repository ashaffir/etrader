...
def format_help() -> str:
    return (
        ...
        "  /directives        list operator directives (persistent rules)\n"
        "  /directive set <k> <v> | clear <k>   edit one directive\n"
        "  /note add|clear <text>   free-text directive surfaced to the LLM\n"
        "  /tokens            LLM token consumption + cost estimate\n"
        "  /help              this message\n"
        "\n"
